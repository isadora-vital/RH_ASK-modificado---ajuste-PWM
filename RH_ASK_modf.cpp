// MODIFICAÇÕES PARA QUE O BIT SEJA ENVIADO CONFORME O PWM -> ADEQUAÇÃO DA INFO DE ACORDO COM A FREQUÊNCIA
// RH_ASK.cpp
//
...
{
  ledcAttachChannel(4, 126000, 8, 0);
#if (RH_PLATFORM == RH_PLATFORM_GENERIC_AVR8)
